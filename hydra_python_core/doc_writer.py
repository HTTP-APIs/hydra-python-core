...
class HydraDoc:
    ...
    def add_supported_class(self, class_: "HydraClass") -> None:
        ...
        self.parsed_classes[class_.path] = {
            "context": Context(
                address="{}{}".format(self.base_url, self.API), class_=class_
            ),
            "class": class_,
        }
    ...
    def add_supported_collection(self, collection_: "HydraCollection") -> None:
        ...
        self.collections[collection_.path] = {
            "context": Context(
                address="{}{}".format(self.base_url, self.API), collection=collection_
            ),
    ...
    def add_baseCollection(self) -> None:
        ...
        collection = HydraClass(
            _id="http://www.w3.org/ns/hydra/core#Collection",
            title="Collection",
            desc=None,
        )
    ...
    def add_to_context(self, key: str, value: Union[Dict[str, str], str]) -> None:
    ...
    def generate(self) -> Dict[str, Any]:
        ...
        parsed_classes = [
            self.parsed_classes[key]["class"] for key in self.parsed_classes
        ]
...
class HydraClass:
    ...
    def add_supported_prop(
        self, prop: Union["HydraClassProp", "EntryPointClass", "EntryPointCollection"]
    ) -> None:
    ...
    def add_supported_op(self, op: Union["EntryPointOp", "HydraClassOp"]) -> None:
...
class HydraCollection:
    ...
    def __init__(
        ...
        self.collection_id = "{}{}".format(
            DocUrl.doc_url, quote(collection_name, safe="")
        )
        ...
        if get:
            get_op = HydraCollectionOp(
                ...
                "GET",
                "Retrieves all the members of {}".format(self.name),
                None,
                self.manages["object"],
                [],
                [],
        ...
        if put:
            put_op = HydraCollectionOp(
                "_:{}_create".format(self.name),
                "http://schema.org/AddAction",
                "PUT",
                "Create new member in {}".format(self.name),
                self.manages["object"],
                self.manages["object"],
                [],
                [],
                [
                    HydraStatus(
                        code=201, desc="A new member in {} created".format(self.name)
                    )
                ],
            )
        ...
        if post:
            post_op = HydraCollectionOp(
                ...
                "POST",
                "Update member of  {} ".format(self.name),
                self.manages["object"],
                self.manages["object"],
                [],
                [],
                [
                    HydraStatus(
                        code=200,
                        desc="If the entity was updated" "from {}.".format(self.name),
                    )
                ],
            )
        ...
        if delete:
            delete_op = HydraCollectionOp(
                ...
                "DELETE",
                "Delete member of {} ".format(self.name),
                self.manages["object"],
                self.manages["object"],
                [],
                [],
...
class HydraEntryPoint:
    ...
    def __init__(self, base_url: str, entrypoint: str) -> None:
        ...
        self.entrypoint.add_supported_op(
            EntryPointOp(
                "_:entry_point".format(base_url),
                "GET",
        ...
        self.context = Context("{}{}".format(base_url, entrypoint), entrypoint=self)
    ...
    def add_Class(self, class_: HydraClass) -> None:
        ...
        self.context.add(
            entrypoint_class.name, {"@id": entrypoint_class.id_, "@type": "@id"}
        )
        ...
        for item in self.entrypoint.supportedProperty:
            ...
            if item.generate() in self.collections:
                ...
                collection_to_append = {
                    ...
                    "@type": "Collection",
                    "supportedOperation": collection_returned["property"][
                        "supportedOperation"
                    ],
...
class EntryPointCollection:
    ...
    def __init__(self, collection: HydraCollection) -> None:
        ...
        if collection.path:
            self.id_ = "{}EntryPoint/{}".format(
                DocUrl.doc_url, quote(collection.path, safe="")
            )
    ...
    def generate(self) -> Dict[str, Any]:
        ...
        object_ = {
            "property": {
                ...
                "@type": "hydra:Link",
                "label": self.name,
                "description": "The {} collection".format(
                    self.name,
                ),
            ...
            "hydra:description": "The {} collection".format(
                self.name,
            ),
            "required": None,
            "readable": True,
...
class IriTemplateMapping:
    ...
    def __init__(self, variable: str, prop: str, required: bool = False):
...
class HydraStatus:
    ...
    def __init__(
        self, code: int, id_: str = None, title: str = "", desc: str = ""
    ) -> None:
        """Create method."""
        self.code = code
        self.id_ = id_
...
class Context:
    ...
    def __init__(
        ...
        if class_ is not None:
            ...
            self.context = {
                "hydra": "http://www.w3.org/ns/hydra/core#",
                "property": {"@type": "@id", "@id": "hydra:property"},
                "supportedClass": "hydra:supportedClass",
                "supportedProperty": "hydra:supportedProperty",
                "supportedOperation": "hydra:supportedOperation",
                "label": "rdfs:label",
                "rdf": "http://www.w3.org/1999/02/22-rdf-syntax-ns#",
                "domain": {"@type": "@id", "@id": "rdfs:domain"},
                "ApiDocumentation": "hydra:ApiDocumentation",
                "range": {"@type": "@id", "@id": "rdfs:range"},
                "rdfs": "http://www.w3.org/2000/01/rdf-schema#",
                "title": "hydra:title",
                "expects": {"@type": "@id", "@id": "hydra:expects"},
                "returns": {"@id": "hydra:returns", "@type": "@id"},
                "entrypoint": {"@id": "hydra:entrypoint", "@type": "@id"},
                "object": {"@id": "hydra:object", "@type": "@id"},
